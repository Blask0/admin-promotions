...
import { REWARD_EFFECT_ORDER_STATUS_OPTIONS } from '../../../utils/constants'
      ...
      <Fragment>
        ...
        <div className="mh4 mt4">
          <EXPERIMENTAL_Select
            ...
            options={REWARD_EFFECT_ORDER_STATUS_OPTIONS}
            value={
              rewardEffect.applyByOrderStatus ||
              REWARD_EFFECT_ORDER_STATUS_OPTIONS[0]
            }
            multi={false}
            onChange={selected => {
